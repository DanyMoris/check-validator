...
class CheckMode(str, Enum):
    """Как бот толкует «успех» проверки."""

    LEDGER = "ledger"
    """Сверка с журналом поступлений: три вердикта, в том числе НЕ ПОДТВЕРЖДЁН."""

    STRUCTURE = "structure"
    """Только файл: настоящий шаблон банка → ПОДЛИННЫЙ, чужая программа → ПОДДЕЛКА."""


class Verdict(str, Enum):
    CONFIRMED = "ПОДТВЕРЖДЁН"
    """Подпись проверена либо найдено реальное поступление денег (режим выписок)."""

    GENUINE = "ПОДЛИННЫЙ"
    """Файл совпал с шаблоном банка. Деньги на счёт это не доказывает."""
